...
# Read the markdown privacy policy
with open('PRIVACY_POLICY_SOURCE.md', 'r') as f:
    md_content = f.read()

# Create the React component with the privacy policy content
react_component = '''import Link from 'next/link';
...
print("✅ Privacy policy page updated!")
